...
exports.updateProfile = async (req, res) => {
  try {
    const { name, department, position, phone, notificationPreferences, theme } = req.body;
    const updateData = { name, department, position, phone, notificationPreferences, theme };

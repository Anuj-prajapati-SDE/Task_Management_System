...
export const CreateTaskPage = () => {
  ...
  return (
    <div>
      <SEO title="Create Task" description="Create and delegate a new task to team members on TaskFlow." robots="noindex, nofollow" />
          ...
          <div className="card" style={{ marginBottom: 20 }}>
            ...
            <div className="form-row">
              ...
              <div className="form-group">
                ...
                <input className="form-control" type="datetime-local" value={form.dueDate} onChange={e => setForm({ ...form, dueDate: e.target.value })} />
              </div>
            </div>
          </div>
